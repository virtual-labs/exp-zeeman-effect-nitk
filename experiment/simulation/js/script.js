...
function update() {
  ...
  if (option == "mfield vs current") {
    ...
    document.getElementsByClassName("procedure-title")[0].style.display =
      "none";
...
function insert() {
  ...
  if (pcheck == true) {
    ...
    document.getElementById("mertube").style.animation =
      "insertdistube 2s forwards";
    setTimeout(function () {
          ...
          document.getElementById("mmreading").onclick = function () {
            setTimeout(function () {
              ...
              setTimeout(function () {
                ...
                document.getElementById("ireading").style.display =
                  "inline-block";
                ...
                document.getElementById("mmreading").onclick = function () {
                  setTimeout(function () {
                    ...
                    document.getElementById("hand1").style.animation =
                      "rotatehand 2.5s forwards";
                    document.getElementById("circle2").style.animation =
                      "movesplitrings 2.5s forwards";
                    setTimeout(function () {
                      document.getElementById("hand1").style.display = "none";
                      document.getElementById("reading2").style.display =
                        "block";
                      document.getElementById("readings").style.display =
                        "block";
                      document.getElementById("sreading").style.display =
                        "inline-block";
                      ...
                      document.getElementById("mmreading").onclick =
                        function () {
                          setTimeout(function () {
                            ...
                            document.getElementById("sreading").style.display =
                              "none";
                            document.getElementById("hand1").style.display =
                              "block";
                            document.getElementById("hand1").style.animation =
                              "rotatehand 2s forwards";
                            document.getElementById("circle2").style.animation =
                              "movesplitrings2 2.5s forwards";
                            setTimeout(function () {
                              document.getElementById("hand1").style.display =
                                "none";
                              ...
                              document.getElementById("sreading").innerHTML =
                                "3.44mm";
                              document.getElementById("mmreading").onclick =
                                function () {
                                  setTimeout(function () {
                                                                                                ...
                                                                                                setTimeout(
                                                                                                  function () {
                                                                                                    ...
                                                                                                    document.getElementById(
                                                                                                      ...
                                                                                                      "movesplitrings10 2.5s forwards";
                                                                                                    setTimeout(
                                                                                                      function () {
                                                                                                        document.getElementById(
                                                                                                          "hand1"
                                                                                                            ...
                                                                                                            setTimeout(
                                                                                                              function () {
                                                                                                                ...
                                                                                                                document.getElementById(
                                                                                                                  ...
                                                                                                                  "movesplitrings11 2.5s forwards";
                                                                                                                setTimeout(
                                                                                                                  function () {
                                                                                                                    document.getElementById(
                                                                                                                      "hand1"
                                                                                                                        ...
                                                                                                                        setTimeout(
                                                                                                                          function () {
                                                                                                                            ...
                                                                                                                            document.getElementById(
                                                                                                                              ...
                                                                                                                              "movesplitrings12 2.5s forwards";
                                                                                                                            setTimeout(
                                                                                                                              function () {
                                                                                                                                document.getElementById(
                                                                                                                                  "hand1"
